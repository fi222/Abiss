...
# Support English, Hebrew, numbers, and space
ALPHANUMERIC = 'abcdefghijklmnopqrstuvwxyzאבגדהוזחטיכלמנסעפצקרשתךםןףץ0123456789 '
POOL_SIZE = 200  # Increased to support longer messages
